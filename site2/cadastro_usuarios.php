                                        ...
                                        <section>
                                            ...
                                            if($usuarios) { ?>
                                                ...
                                                <div class = "row  ">
                                                    ...
                                                    <div class = "col-12 col-md-5 col-lg-3 col-xl-6  justify-content-start" >CPF</div>
                                                ...
                                                foreach ($usuarios as $usuario) {
                                                    ...
                                                    <div class = "row  ">
                                                        ...
                                                        <div class = "col-12 col-md-5 col-lg-3 col-xl-6 "> <?= $cpf; ?> </div>
                                                        <div class = "col-12 col-md-4 col-lg-3 col-xl-3 text-warning" > <?= $nome; ?> </div>
                                    
                                                        <div class = "col-4 col-sm-4 col-md-4 col-lg-1 col-xl-1 mt-1 mb-1 d-flex justify-content-center"  > 

                                                            <a href='modifica_usuario?cpf=<?=$cpf; ?>' class='btn btn-info left-margin ms-1 justify-content-center' title="Alterar">
