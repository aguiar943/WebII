...
<?php
 ...
 class Auth{
    ...
    private static $usuario_bd;
    private static $dao;

    public static function recuperarUsuario($factory){

        self::$dao = $factory->getUsuarioDao();
        
    }

    public static function getUsuarioLogado(){

        return self::$usuario_bd;
    ...
    public static function Logar($botao, $login_encontrado, $isMessage){
        ...
        if(isset($_POST['login'])){
            ...
            if(!$login_encontrado && $isMessage){
                ...
                self::$dao->buscaPorCPF();

                self::$usuario_bd = self::$dao->getUsuarioLogado();

                $_SESSION['usuario'] = serialize(self::$usuario_bd);
            ...
            return 'Olá ' . $usuario_obj->getNome();

            //puxa nome do user no banco
